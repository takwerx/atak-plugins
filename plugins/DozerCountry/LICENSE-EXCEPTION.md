# Licensing notes for DozerCountry

DozerCountry is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of DozerCountry give you permission to
> combine, link with, and distribute DozerCountry, or a work based on DozerCountry, together
...
> resulting work that are DozerCountry, or a work based on DozerCountry.
>
...
**If you only install and use DozerCountry, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/dozercountry/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/dozercountry/plugin/DozerCountry.java`
