# Licensing notes for Cam Depot

Cam Depot is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of Cam Depot give you permission to
> combine, link with, and distribute Cam Depot, or a work based on Cam Depot, together
...
> resulting work that are Cam Depot, or a work based on Cam Depot.
>
...
**If you only install and use Cam Depot, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/camdepot/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/camdepot/plugin/CamDepot.java`
- `app/src/main/java/com/atakmap/android/camdepot/plugin/CamDepotPreferenceFragment.java`
