# Licensing notes for TAKwerx Market

TAKwerx Market is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of TAKwerx Market give you permission to
> combine, link with, and distribute TAKwerx Market, or a work based on TAKwerx Market, together
...
> resulting work that are TAKwerx Market, or a work based on TAKwerx Market.
>
...
**If you only install and use TAKwerx Market, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/takwerxmarket/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/takwerxmarket/plugin/TakwerxMarket.java`
