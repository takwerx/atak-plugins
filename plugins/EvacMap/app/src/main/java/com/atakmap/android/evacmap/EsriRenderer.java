 ...
 * layer always draws. This is how every county's zone colors arrive without a hand
 * mapping per county: the service says what an Order and a Warning look like.
 */
public class EsriRenderer {
    ...
    /** The renderer's readable class label for a feature ("Evacuation Order"), or null. */
        ...
        switch (t) {
            ...
            case "esriSLS": {
                ...
                if ("esriSLSDash".equals(style) || "esriSLSDashDot".equals(style)
                    ...
                    return Styles.dashed(color, pattern(style), 3, width);
                return Styles.solid(color, width);
            }
            case "esriSFS": {
