# TAKwerx Market Contributor License Agreement

**Version 1.0**

## Why this exists — in plain English

TAKwerx Market is licensed under the AGPL so that it stays free: anyone who modifies
...
the copyright holder has standing to do so. If the copyright in TAKwerx Market is
...
2. **You grant TAKWERX a broad license to it** — broad enough to ship it in
   TAKwerx Market, to enforce the AGPL against someone who takes the project
...
does **not** allow TAKWERX to take TAKwerx Market closed — the AGPL grant already
...
which the copyright in TAKwerx Market is later assigned. Except for the
...
> it under the project's license, and I accept the terms of the TAKwerx Market
