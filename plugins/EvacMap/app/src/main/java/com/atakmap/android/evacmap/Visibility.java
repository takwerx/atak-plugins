...
public final class Visibility {
    ...
    static final String PREF_ZOOM = "evacmap_zoom_threshold";
    static final String PREF_RADIUS = "evacmap_radius_big";
    /** The MODE, not the point: "Map Center" means wherever the map is now. */
    static final String PREF_FROM_MAP = "evacmap_radius_from_map";
