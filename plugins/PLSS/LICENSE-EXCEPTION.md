# Licensing notes for PLSS Grid

PLSS Grid is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of PLSS Grid give you permission to
> combine, link with, and distribute PLSS Grid, or a work based on PLSS Grid, together
...
> resulting work that are PLSS Grid, or a work based on PLSS Grid.
>
...
**If you only install and use PLSS Grid, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/plss/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/plss/plugin/PLSS.java`
- `app/src/main/java/com/atakmap/android/plss/plugin/PlssPreferenceFragment.java`
