...
PLSS Grid is free software, licensed under the
...
license is a guarantee that it **stays** free: modify PLSS Grid and pass it on,
...
**If you only install and use PLSS Grid, this obligation never touches you.**
Running it, in any agency, on any number of devices, triggers nothing.

**Scope.** The AGPL covers PLSS Grid's own code. It does not change the license
