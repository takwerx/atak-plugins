# Contributing to PLSS Grid

PLSS Grid is an ATAK plugin, free software under the
...
broad enough to ship it as part of PLSS Grid. This is what lets the project be
